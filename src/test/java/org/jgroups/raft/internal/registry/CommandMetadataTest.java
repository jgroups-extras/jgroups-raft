...
public class CommandMetadataTest {
    ...
    public void testSubmitValidInput() throws Throwable {
        ...
        CommandMetadata metadata = new CommandMetadata(target, 1, 1, null, method,
    ...
    public void testSubmitPrimitiveWithAutoboxing() throws Throwable {
        ...
        CommandMetadata metadata = new CommandMetadata(target,2, 1, null, method,
    ...
    public void testSubmitNoArgMethod() throws Throwable {
        ...
        MetadataTarget target = new MetadataTarget();
        CommandMetadata metadata = new CommandMetadata(target,3, 1, null, method,
    ...
    public void testSubmitGenericBounds() throws Throwable {
        ...
        MetadataTarget target = new MetadataTarget();
        CommandMetadata metadata = new CommandMetadata(target, 4, 1, null, method,
    ...
    public void testSubmitGenericArrayBounds() throws Throwable {
        ...
        MetadataTarget target = new MetadataTarget();
        CommandMetadata metadata = new CommandMetadata(target, 5, 1, null, method,
                List.of(new CommandSchema(inputType)), new CommandSchema(returnType));
    ...
    public void testSubmitInvalidInput() throws Throwable {
        Method method = MetadataTarget.class.getMethod("singleArg", String.class);
        MetadataTarget target = new MetadataTarget();
        CommandMetadata metadata = new CommandMetadata(target, 6, 1, null, method,
                List.of(new CommandSchema(String.class)), new CommandSchema(String.class));
