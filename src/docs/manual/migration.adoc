...
For users migrating to 2.0.x.

==== LevelDBLog was removed

We removed the `LevelDBLog` implementation completely.
You can see the migration guide between 1.0.x to 1.1.x to utilize the migration tool to move to the `FileBasedLog` implementation.
