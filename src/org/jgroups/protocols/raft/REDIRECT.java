        ...
        switch(hdr.type) {
            ...
            case RSP:
                ...
                if(future != null) {
                    ...
                    if(!hdr.exception)
                        future.complete(msg.getRawBuffer());
                    else {
                        try {
                            Throwable t=Util.objectFromByteBuffer(msg.getRawBuffer());
